...
const SignUp = () => {
  ...
  return (
    <main className="min-h-screen flex">
      ...
      <div className="flex w-full md:w-1/2 items-center justify-center bg-[#E6E2B0]">
        <section className="w-full max-w-md rounded-2xl bg-[#FFFCDE] p-6 shadow-xl ring-1 ring-black/5">
          <h1 className="text-2xl font-bold text-[#440A0A]">Create Account</h1>
          <p className="mt-1 text-sm text-zinc-700">
            Sign up with your personal information and password.
          </p>
          ...
          <form onSubmit={onSubmit} className="mt-6 space-y-4">
            <div className="flex gap-4">
              <label className="block flex-1">
                <span className="text-sm text-[#440A0A]">First Name</span>
                <input
                  type="text"
                  required
                  value={firstName}
              ...
              <label className="block flex-1">
                <span className="text-sm text-[#440A0A]">Last Name</span>
                <input
                  type="text"
                  required
                  value={lastName}
            ...
            <label className="block">
              <span className="text-sm text-[#440A0A]">Confirm Password</span>
              <div className="mt-1 relative">
                <input
